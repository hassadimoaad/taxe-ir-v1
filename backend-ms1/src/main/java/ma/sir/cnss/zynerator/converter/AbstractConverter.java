package ma.sir.cnss.zynerator.converter;


import ma.sir.cnss.zynerator.bean.Etablissement;
import ma.sir.cnss.zynerator.dto.EtablissementDto;

import ma.sir.cnss.zynerator.util.ListUtil;
import ma.sir.cnss.zynerator.audit.AuditBusinessObject;
import ma.sir.cnss.zynerator.bean.BusinessObject;
import ma.sir.cnss.zynerator.dto.AuditBaseDto;
import ma.sir.cnss.zynerator.dto.BaseDto;
import ma.sir.cnss.zynerator.util.DateUtil;
import ma.sir.cnss.zynerator.util.RefelexivityUtil;
import ma.sir.cnss.zynerator.util.StringUtil;
import ma.sir.cnss.zynerator.util.Utils;
