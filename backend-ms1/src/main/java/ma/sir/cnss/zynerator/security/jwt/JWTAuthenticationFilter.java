package ma.sir.cnss.zynerator.security.jwt;
...
import ma.sir.cnss.CnssApplication;
import ma.sir.cnss.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = CnssApplication.getCtx().getBean(UserService.class);
